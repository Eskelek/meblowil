...
<body>
    ...
    <header class="col-12 hideToLoad">
        ...
        <div class="col-11 header--logo">
            <a href="index.php"><img class="header--logo__img" alt="logo Meblo-wil" src="images/logoMebloWil.png"></a>
    ...
    <section class="aboutAs col-12 hideToLoad" id="aboutAs">
        <div class="aboutAs--description col-9 col-s-12">
            ...
            <div class="col-12">
                <button><a>Nasze meble <i class=" fas fa-chevron-right"></i></a></button>
            </div>
        </div>
    ...
    <section class="contact col-12 hideToLoad row">
        ...
        <div class="col-9 col-m-11 col-s-12 contact--box">
            ...
            ?>
            <form action="index.php" method="post" class="contact--box--form col-6 col-s-12 row">
                <h2 class="col-12">SKONTAKTUJ SIĘ Z NAMI</h2>
                <div class="formdata row col-5 col-s-12">
                    <input required type="text" min="2" name="name" minlength="2" placeholder="Imię i Nazwisko" class="col-11 col-s-12">
                    <input required type="text" min="2" placeholder="Temat wiadomości" name="subject" class="col-11 col-s-12">
                    <input required type="tel" min="9" max="9" maxlength="9" minlength="9" name="phone" placeholder="Telefon" class="col-11 col-s-12">
                    <input required type="email" name="email" placeholder="Email" class="col-11 col-s-12">
                </div>
                <div class="formMessage col-7 col-s-12">
                    <textarea required class="col-12 message" min="2" name="message" placeholder="Napisz do nas"></textarea>
                    <input type="submit" name="submit" class="col-12 submit" value="WYŚLIJ">
                </div>
            </form>
